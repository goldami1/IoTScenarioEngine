...
class App extends PureComponent {
	...
	render() {
		const bannerErrorIcon = (
			<ErrorIcon label="Error icon" secondaryColor="inherit" />
		);
		const bannerWarningIcon = (
			<WarningIcon label="Warning icon" secondaryColor="inherit" />
		);
		...
		return (
			<div>
				<Page
					...
					navigation={
						<Navigation onNavResize={this.props.onNavResize} />
					}
				>
					<Banner
						icon={
							this.props.banner.appearance == "warning"
								? bannerWarningIcon
								: bannerErrorIcon
						}
