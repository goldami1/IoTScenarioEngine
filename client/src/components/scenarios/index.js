			...
			<div className="m-5">
				...
				{/*<div className="col-md-4">*/}
					<ScenarioList
						...
						onScenarioSelect={ selectedScenario => this.setState({ selectedScenario })}
						onScenarioDelete={ selectedScenario => this.props.deleteScenario({ selectedScenario })} />
				{/*</div>*/}
...
export default connect(mapStateToProps, { fetchScenarios, deleteScenario })(ScenariosPage);
